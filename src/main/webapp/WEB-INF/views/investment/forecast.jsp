...
<body>
  ...
  <div class="form-group">
    ...
    <input type="number" min="0" step=".01" class="form-control" id="initialAmount" name="initialAmount" value='${initialAmount }' placeholder="0.00">
  </div>
  <div class="form-group">
    <label for="rate">Interest Rate(%)</label>
    <input type="number" min="0" step="any" class="form-control" id="rate" name="rate" value='${rate}' placeholder="0.00">
  </div>
  <div class="form-group">
    <label for="months">Investment Term</label>
    <input  type="number" min="0" step="1" class="form-control" id="months" name="months" value='${months}' placeholder="Number of Months">
  </div>
